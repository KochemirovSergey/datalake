...
**Gold — реализован, читает из Silver и Bronze:**
- `gold.students` (51,268 rows) — обучающиеся по возрастам (0–80), регионам и уровням образования (14 уровней)
- `gold.staff_load` (1,360 rows) — педагогическая нагрузка: численность, квалификация, стаж, дефицит кадров по уровням
- `gold.dormitory` (1,260 rows) — метрики общежитий: площади, нехватка мест, ремонт, прогноз
